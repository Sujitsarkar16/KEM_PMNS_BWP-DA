"""
Random Forest Baseline - Clean Top 15 Features (No Data Leakage)
=================================================================

This script implements a baseline Random Forest model using the clean top 15 features.
...
class RFTop30Baseline:
    """
    Random Forest baseline model using top 30 engineered features
    """
    
    def __init__(self, data_path='paper/data/clean_top15_features_20251206.csv'):
        """Initialize RF baseline implementation with CLEAN features"""
    ...
    def save_results(self):
        ...
        output_dir = 'paper/results/rf_baseline_clean_top15'
        ...
        comprehensive_results = {
            'model_type': 'RandomForest_Baseline_Clean_Top15_NoLeakage',
        ...
        # Save JSON
        results_file = f'{output_dir}/rf_top30_baseline_results_{timestamp}.json'
        ...
        metrics_file = f'{output_dir}/rf_top30_baseline_metrics_{timestamp}.csv'
        metrics_df.to_csv(metrics_file, index=False)
        
        # Save feature importance
        importance_file = f'{output_dir}/rf_top30_baseline_importance_{timestamp}.csv'
        self.feature_importance.to_csv(importance_file, index=False)
        
        # Save model
        model_file = f'{output_dir}/rf_top30_baseline_model_{timestamp}.pkl'
    ...
    def run_baseline(self):
        ...
        print("=" * 80)
        print("RANDOM FOREST BASELINE - CLEAN TOP 15 FEATURES (NO LEAKAGE)")
        print("=" * 80)
...
def main():
    """Main function"""
    print("=" * 80)
    print("RANDOM FOREST BASELINE - TOP 30 ENGINEERED FEATURES")
    print("=" * 80)
    ...
    # Initialize and run
    baseline = RFTop30Baseline(data_path=data_path)
