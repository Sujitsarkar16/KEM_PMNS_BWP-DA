...
using Top 25 variables from feature importance ranking.
...
class BARTModel:
    ...
    for birthweight prediction using Top 25 variables
    """
    ...
    def create_visualizations(self):
        ...
        plt.tight_layout()
        plot_file = f'{plot_dir}/bart_top25_performance.png'
    ...
    def save_results(self):
        ...
        # Create output directory
        output_dir = 'Data/processed/BART_Top25'
        ...
        # Save JSON results
        results_file = f'{output_dir}/bart_top25_results_{timestamp}.json'
        ...
        metrics_file = f'{output_dir}/bart_top25_metrics_{timestamp}.csv'
        metrics_df.to_csv(metrics_file, index=False)
        
        # Save model (if pickleable)
        try:
            model_file = f'Models/bart_top25_model_{timestamp}.pkl'
    ...
    def run_complete_analysis(self, n_trees=200, n_burn=200, n_samples=1000, 
        ...
        print("=" * 80)
        print("BART MODEL - TOP 25 VARIABLES")
        print("=" * 80)
...
def main():
    ...
    print(f"  - Features: Top 25 variables")
