...
├── Data\
│   ├── external\
│   │   └── PMNS F0 Mother, FAther & F1 Child Serial Final Data Dictionary (GCRF - MAS3)_20JULY2021-DEscr.xlsx
│   ├── final\
│   ├── interim\
│   ├── processed\
│   │   ├── birthweight_descriptive_table.csv
│   │   ├── cleaned_dataset_summary.csv
│   │   ├── cleaned_dataset_with_engineered_features.csv
│   │   ├── dermatoglyphic_features_simple.parquet
│   │   ├── mle_performance_metrics.csv
│   │   ├── mle_performance_results.json
│   │   ├── mle_results.json
│   │   └── variable_grouping_table.csv
│   └── raw\
│       └── IMPUTED_DATA_WITH REDUCED_columns_21_09_2025.xlsx
├── Models\
├── NoteBooks\
│   └── create_plots.ipynb
├── PLOTS\
│   ├── dermatoglyphic_qc_simple\
│   │   ├── feature_distributions.png
│   │   └── summary_correlation_heatmap.png
│   ├── Feature_Engineering\
│   │   ├── birthweight_analysis.png
│   │   ├── boxplots.png
│   │   ├── comprehensive_birthweight_analysis.png
│   │   ├── comprehensive_eda_analysis.png
│   │   ├── correlation_heatmap.png
│   │   ├── data_quality_summary.png
│   │   ├── data_types_distribution.png
│   │   ├── detailed_imputation_analysis.png
│   │   ├── domain_distribution_eda.png
│   │   ├── Figure_1.png
│   │   ├── key_variables_correlation.png
│   │   ├── missingness_heatmap.png
│   │   └── numerical_histograms.png
│   ├── missingness_heatmap_key_vars.png
│   ├── mle_performance_metrics.png
│   └── mle_results_visualization.png
├── Reports\
│   ├── COMPREHENSIVE_EDA_REPORT.md
│   ├── data_audit_report.xlsx
│   └── eda_summary_report.csv
├── Scripts\
│   ├── calculate_rmse.py
│   ├── Feature_Engineering\
│   │   ├── 01_create_plots.py
│   │   ├── comprehensive_eda_analysis.py
│   │   ├── data_audit_analysis.py
│   │   ├── EDA.ipynb
│   │   ├── feature_categorization_analysis.py
│   │   ├── generate_remaining_plots.py
│   │   ├── save_cleaned_dataset.py
│   │   └── simple_dermatoglyphic_feature_extraction.py
│   ├── MLE_Procedural_Notebook_Explanation.md
│   ├── mle_procedural_notebook_with_evaluation.ipynb
│   ├── mle_simple.py
│   └── PLOTS\
├── Summary\
│   ├── MLE\
│   │   ├── MLE_Files_Summary.md
│   │   ├── MLE_Implementation_Guide.txt
│   │   └── MLE_Implementation_Summary.md
│   └── Step_1[FE]\
│       ├── Analysis_Process_Flow.md
│       ├── Complete_Analysis_Summary.md
│       ├── Step2_Feature_Categorization_Analysis.md
│       ├── Step3_Outcome_Variable_Engineering.md
│       ├── Step4_Exploratory_Data_Analysis.md
│       └── Steps2_3_Complete_Analysis_Overview.md
└── README.md
```
...
- **`Data/`**: Contains all data files organized by processing stage
  - `external/`: External reference files and data dictionaries
  - `raw/`: Original, unprocessed data files
  - `interim/`: Intermediate processing files
  - `processed/`: Final processed datasets ready for analysis
...
- **`PLOTS/`**: All generated visualizations and plots
  - `dermatoglyphic_qc_simple/`: Dermatoglyphic analysis visualizations
  - `Feature_Engineering/`: Feature engineering and EDA plots

- **`Reports/`**: Analysis reports, summaries, and documentation

- **`Scripts/`**: Python scripts for data processing and analysis
  - `Feature_Engineering/`: Feature engineering specific scripts
  - `PLOTS/`: Plot generation scripts

- **`Summary/`**: Detailed summaries and documentation
