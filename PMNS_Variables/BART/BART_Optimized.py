"""
BART (Bayesian Additive Regression Trees) Hyperparameter Optimization - PMNS Dataset
=====================================================================================
...
Supports:
- 20 variables from the PMNS Dataset
...
class BARTHyperparameterOptimizer:
    """
    BART hyperparameter optimization using RandomizedSearchCV
    for the PMNS 20 variables dataset
    """
    ...
    def create_visualizations(self):
        ...
        plot_dir = 'PLOTS/BART_PMNS20_Optimized'
    ...
    def save_results(self):
        ...
        # Create output directory
        output_dir = 'Data/processed/BART_PMNS20_Optimized'
        ...
        comprehensive_results = {
            'model_type': 'BART_Optimized_PMNS20',
        ...
        # Save JSON results
        results_file = f'{output_dir}/bart_optimized_pmns20_results_{timestamp}.json'
        ...
        metrics_file = f'{output_dir}/bart_optimized_pmns20_metrics_{timestamp}.csv'
        metrics_df.to_csv(metrics_file, index=False)
        
        # Save all CV results
        cv_results_df = pd.DataFrame(self.search_results.cv_results_)
        cv_results_file = f'{output_dir}/bart_pmns20_cv_search_results_{timestamp}.csv'
    ...
    def run_optimization(self, cv_folds=5, n_iter=20, random_state=42):
        ...
        print("=" * 80)
        print("BART HYPERPARAMETER OPTIMIZATION - PMNS 20 VARIABLES")
        print("=" * 80)
