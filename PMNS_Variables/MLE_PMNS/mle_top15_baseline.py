"""
MLE Baseline - PMNS Variables (20 Features from Previous Work)
===============================================================

This script implements a baseline MLE model using the 20 features
...
class MLEPMNSBaseline:
    """
    MLE baseline model using 20 PMNS features from previous research
    """
    ...
    def load_and_prepare_data(self):
        ...
        print("\n[PMNS FEATURES FROM PREVIOUS WORK]:")
    ...
    def save_results(self):
        ...
        comprehensive_results = {
            'model_type': 'MLE_Baseline_PMNS_Variables',
        ...
        # Save JSON results
        results_file = f'{output_dir}/mle_pmns_baseline_results_{timestamp}.json'
        ...
        metrics_file = f'{output_dir}/mle_pmns_baseline_metrics_{timestamp}.csv'
    ...
    def run_baseline(self):
        ...
        print("=" * 80)
        print("MLE BASELINE MODEL - PMNS VARIABLES (20 FEATURES)")
        print("=" * 80)
...
def main():
    """Main function"""
    print("=" * 80)
    print("MLE BASELINE MODEL - PMNS VARIABLES")
    print("=" * 80)
    ...
    print(f"\n[Configuration]:")
    print(f"  - Using PMNS features from previous work")
    ...
    baseline = MLEPMNSBaseline(data_path=data_path)
