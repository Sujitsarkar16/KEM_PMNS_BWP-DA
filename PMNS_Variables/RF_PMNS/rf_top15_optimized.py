"""
Random Forest Optimized - PMNS Variables (20 Features from Previous Work)
==========================================================================

This script implements an optimized Random Forest model using the 20 features
...
class RFPMNSOptimized:
    """
    Random Forest optimized model with hyperparameter tuning for PMNS features
    """
    
    def __init__(self, data_path='e:/KEM/Project/Data/PMNS_Data.csv'):
        """Initialize RF optimized implementation"""
    ...
    def train_final_model(self, random_state=42):
        ...
        print(f"[OK] Model trained with {self.best_model.n_estimators} trees")
    ...
    def save_results(self):
        ...
        comprehensive_results = {
            'model_type': 'RandomForest_Optimized_PMNS_Variables',
        ...
        results_file = f'{output_dir}/rf_pmns_optimized_results_{timestamp}.json'
        ...
        metrics_file = f'{output_dir}/rf_pmns_optimized_metrics_{timestamp}.csv'
        pd.DataFrame(metrics_data).to_csv(metrics_file, index=False)
        
        importance_file = f'{output_dir}/rf_pmns_optimized_importance_{timestamp}.csv'
        self.feature_importance.to_csv(importance_file, index=False)
        
        model_file = f'{output_dir}/rf_pmns_optimized_model_{timestamp}.pkl'
    ...
    def run_optimization(self, n_iter=50, cv_folds=5, random_state=42):
        ...
        print("=" * 80)
        print("RANDOM FOREST OPTIMIZED - PMNS VARIABLES (20 FEATURES)")
        print("=" * 80)
...
def main():
    ...
    optimizer = RFPMNSOptimized(data_path=data_path)
